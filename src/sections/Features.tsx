            ...
            <div className="container">
                ...
                <div className="mt-12 grid grid-cols-1 lg:grid-cols-3 md:grid-cols-4 gap-8">
                    ...
                    >
                        <div className="aspect-video flex items-center justify-center gap-4">
                            <Key className="w-28 key delay-450">shift</Key>
                            <Key className="key delay-150">alt</Key>
                            <Key className="key delay-300">C</Key>
                        </div>
                    </FeatureCard>
                </div>
                <div className="mt-8 flex flex-wrap gap-3 justify-center">
                    {features.map((feature, id) => (
                        <div
                            key={id}
                            className="bg-neutral-900 border-white/10 inline-flex px-3 md:px-5 md:py-2 py-1.5 rounded-2xl gap-3 items-center hover:scale-105 transition duration-500 group"
                        >
